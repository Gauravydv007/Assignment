...
class _HomepageState extends State<Homepage> {
  ...
  //   if (firebaseUser != null) {
  //     final userDoc =
  //         await FirebaseFirestore.instance.collection('user').doc(firebaseUser.uid).get();
  //     if (userDoc.exists) {
  //       setState(() {
  //         myEmail = userDoc.data()?['email'] ?? '';
  //         username = userDoc.data()?['username'] ?? '';
  //         imageUrl = userDoc.data()?['images'] ?? '';
  //       });
  //     }
  //   }
  // }
          ...
          // ],
                  ...
                  actions: [
                    ...
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                        backgroundImage: imageUrl.isNotEmpty ? NetworkImage(imageUrl) as ImageProvider<Object>? : AssetImage('assets/images/icons8-camera.png'),
                      ),
                    ),
                PopupMenuButton<MenuAction>(
                  onSelected: (value) async {
